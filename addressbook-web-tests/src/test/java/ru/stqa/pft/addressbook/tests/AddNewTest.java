...
public class AddNewTest {
  ...
  public void addNewContact() {
    gotoAddNewPage();
    fillNewContactForm(new NewContactData("Fname", "Mname", "Lname", "Nname", "ooo\"company\"", "Email@gmail.com", "5-555-555"));
    enterNewContact();
    returnToHomePage();
  }
  ...
  private void fillNewContactForm(NewContactData newContactData) {
    ...
    wd.findElement(By.name("home")).sendKeys(newContactData.getHomeTelephone());
  }
